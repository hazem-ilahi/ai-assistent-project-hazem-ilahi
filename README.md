...
```
cd existing_repo
git remote add origin https://mygit.th-deg.de/hi15953/ai-assistant-project-hazemilahi.git
git branch -M main
...
- [ ] [Set up project integrations](https://mygit.th-deg.de/hi15953/ai-assistant-project-hazemilahi/-/settings/integrations)
